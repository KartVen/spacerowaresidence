/*
MIT License
Copyright (c) 2017 Krittanon Wisedchart
*/

var bg_color_img_box = '#000C'
...
window.onload = function() {
    ...
    crtdv_img_box.id = 'img_box_old'
    document.getElementsByTagName('body')[0].appendChild(crtdv_img_box)
    idpopup_img_box = document.getElementById("img_box_old")
...
function img_box_old(self) {
    ...
    img_img_box.onload = function() {
        ...
        if (wimg_img_box > wwin_img_box && himg_img_box < hwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.maxWidth = '95%'
        }
        else if (himg_img_box > hwin_img_box) {
            idpopup_img_box.getElementsByTagName('img')[0].style.maxHeight = '95%'
