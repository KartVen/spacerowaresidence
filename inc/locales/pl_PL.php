...
return [
    //HOME_PAGE
    'banner.text' => 'Wybierz Swój<br/>Wymarzony Dom',
    'banner.subtext' => 'Nowe oferta domów. Sprawdź już dzisiaj!',
    'headline_que.1' => 'Czym jest <span>Osiedle Spacerowe</span>?',
    'headline_que.2' => 'Co <span>zyskujesz</span>?',
    'section.info.intro' => [
        'Nasza oferta',
        '
    ...
    'home.table.home' => 'Dom',
    'home.table.link' => 'dom',
    'home.table.category' => 'domy',
    'home.table.build_type' => 'Typ budynku',
    'home.table.garden_type' => 'Typ ogródka',
    'home.table.usable_area' => 'Powierzchnia użytkowa',
    'home.table.addon_area' => 'Powierzchnia dodatkowa',
    'home.table.sale_status' => 'Status',
    'home.table.prize' => 'Cena',
    'home.table.corner' => 'Narożny',
    'home.table.type' => 'Typ',
    'home.table.occupied' => 'sprzedany',
    'home.table.reservation' => 'rezerwacja',
    'home.table.free' => 'wolne',
    'home.table.garden' => 'Ogródek',
    'home.table.terrace' => 'Taras',
    'home.table.check' => 'SPRAWDŹ',
    'home.table.legend' => [
        'Legenda',
        '
            <p>TYP – DOM „POWTARZALNY” TZN. TAKA SAMA POW.UŻYTK. M2</p>
            <p>PR – GARAŻ PO PRAWEJ STRONIE PATRZĄC OD ELEWACJI FRONTOWEJ</p>
            <p>L – GARAŻ PO LEWEJ STRONIE</p>
            <p>OT – OGRÓDEK TYPOWY</p>
            <p>OP – OGRÓDEK POWIĘKSZONY</p>
        ',
    ],
    'section.localisation.head' => 'Nasza lokalizacja',
    'section.visualisation.head' => 'Wizualizacje wewnętrzne',
    'details.hq_title' => 'SIEDZIBA FIRMY',
    'details.street' => 'ul.',
    'details.country' => 'Polska',
    'details.attention' => 'UWAGA',
    'details.legal_info' => 'Informacje zawarte w materiałach reklamowych Osiedle Spacerowe, nie stanowią oferty handlowej w rozumieniu przepisów Kodeksu Cywilnego.',
    'contact.head' => 'Skontaktuj się z nami',
    'contact.intro' => 'Zastanawiasz się na kupnem domu, ale potrzebujesz dodatkowych informacji? <br/> Skontaktuj się z nami.',
    'contact.data_admin' => 'Administratorem danych jest firma SPACEROWA RESIDENCE Sp. z o.o. Sp. komandytowa, ul. Ułańska 13, 52-213 Wrocław. Podanie danych jest dobrowolne, powyższe dane będą przetwarzane przez firmę SPACEROWA RESIDENCE Sp. z o.o. Sp. komandytowa, w celu przekazania informacji o ofercie handlowej (telefonicznie lub e-mailowo). Przysługuje Państwu prawo dostępu do treści swoich danych, ich poprawiania lub usunięcia. Wszelką korespondencję w sprawach związanych z przetwarzaniem danych osobowych, o którym mowa powyżej, należy kierować na adres: firmy SPACEROWA RESIDENCE Sp. z o.o. Sp. komandytowa, ul. Ułańska 13, 52-213 Wrocław z dopiskiem „Dane Osobowe”.',
    // HOUSE_PAGE
    'section.cover.text' => 'Osiedle Spacerowe',
    'section.cover.subtext' => 'Dom Nr %s',
    'house.table.prize_total' => 'Cena (całkowita)',
    'house.table.prize_meter' => 'Cena (za metr)',
    'house.table.usable_area' => 'Powierzchnia użytkowa',
    'house.table.garden_area' => 'Powierzchnia ogródka',
    'house.table.corner' => 'Narożny',
    'house.table.build_type' => 'Typ',
    'house.table.build_height' => 'Wysokość mieszkania',
    'house.table.occupied' => 'sprzedany',
    'house.table.reservation' => 'zarezerwowany',
    'house.table.free' => 'wolne',
    'house.table.status' => 'Status',
    'section.cross.head' => 'Elewacje, przekroje',
];